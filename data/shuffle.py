...
def jointly_shuffle_files(files, chunk_size, temporary=False):
    ...
    Args:
        ...
        chunk_size: chunk size to shuffle data
    ...
    return [_sort_file(path, ordering, temporary, CHUNK_SIZE) for path in files]


def _sort_file(path, ordering, temporary, CHUNK_SIZE):
...
if __name__ == '__main__':
    jointly_shuffle_files(files=sys.argv[1:-1], chunk_size=sys.argv[-1])
