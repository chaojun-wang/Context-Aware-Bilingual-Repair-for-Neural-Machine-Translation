...
def main(settings):
    ...
    if settings.translation_strategy == 'beam_search':
        sampler = BeamSearchSampler(models, configs, settings.beam_size, settings.conservative_penalty,
                                    settings.conservative_way)
    else:
    ...
    translate_utils.translate_file(
        ...
        conservative_penalty=settings.conservative_penalty,
